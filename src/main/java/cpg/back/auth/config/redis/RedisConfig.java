...
//
//    private final RedisPoolConfig redisPoolConfig;
//    @Bean
...
//                .commandTimeout(redisPoolConfig.getTimeBetweenEvictionRuns())
//                .shutdownTimeout(redisPoolConfig.getTimeBetweenEvictionRuns())
//                .build();
//
...
//    }
//
//    public void connectionLogging(RedisPoolConfig config) {
